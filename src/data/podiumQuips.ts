...
export const podiumQuips: Record<number, PodiumQuipSet> = {
  100: {
    ...
    soloPodium: "{leader} stands alone! The undisputed, lonely heavyweight champion of the world!"
  },
  99: {
    ...
    soloPodium: "{leader} is 100% of the scoreboard."
  },
  98: {
    ...
    soloPodium: "{leader} is loud and proud."
  },
  97: {
    ...
    soloPodium: "{leader} is the shark. You are the bait."
  },
  96: {
    ...
    soloPodium: "{leader} is the champion. For now."
  },
  95: {
    ...
    soloPodium: "{leader} is smiling. You are frowning."
  },
  94: {
    ...
    soloPodium: "{leader} is winning life."
  },
  93: {
    ...
    soloPodium: "{leader} is the favourite child."
  },
  92: {
    ...
    soloPodium: "{leader} is taking the chocolates."
  },
  91: {
    ...
    soloPodium: "{leader} is awake. Good morning {leader}!"
  },
  90: {
    ...
    soloPodium: "{leader} is the vibe. You are the buzzkill."
  },
  89: {
    ...
    soloPodium: "{leader} is supreme leader."
  },
  88: {
    ...
    soloPodium: "{leader} is crushing it. You are being crushed."
  },
  87: {
    ...
    soloPodium: "{leader} is a rockstar. You are the groupies."
  },
  86: {
  ...
  85: {
    ...
    soloPodium: "{leader} is holding the trophy. Don't touch it."
  },
  84: {
    ...
    soloPodium: "{leader} is cash money."
  },
  83: {
    ...
    soloPodium: "{leader} is legit. The rest of you are frauds."
  },
  82: {
    ...
    soloPodium: "{leader} is the expert. Listen and learn."
  },
  81: {
    ...
    soloPodium: "{leader} is doing a Bradbury. Skating through while you all fell over."
  },
  80: {
    ...
    soloPodium: "{leader} is on fire. Someone call the firies."
  },
  79: {
    ...
    soloPodium: "{leader} is the sun. You all orbit them."
  },
  78: {
    ...
    soloPodium: "{leader} is paying the bills. You lot are freeloaders."
  },
  77: {
    ...
    soloPodium: "{leader} is buzzing. Everyone else is flat."
  },
  76: {
    ...
    soloPodium: "{leader} is fresh. The rest of you are stale."
  },
  75: {
    ...
    soloPodium: "{leader} is the boss. Get back to work."
  },
  74: {
    ...
    soloPodium: "{leader} is rolling high numbers. You lot are rolling ones."
  },
  73: {
    ...
    soloPodium: "{leader} is cooking with gas."
  },
  72: {
    ...
    soloPodium: "{leader} is the GOAT. Everyone else is a sheep."
  },
  71: {
    ...
    soloPodium: "{leader} is looking down on you all from a great height."
  },
  70: {
    ...
    soloPodium: "{leader} is the main character. You are all NPCs."
  },
  69: {
    ...
    soloPodium: "{leader} is on the board. Finally, some action!"
  },
  68: {
    ...
    soloPodium: "{leader} is sweating from carrying this team."
  },
  67: {
    ...
    soloPodium: "{leader} is the only one who understood the assignment."
  },
  66: {
    ...
    soloPodium: "{leader} is a lone wolf howling at the moon."
  },
  65: {
    ...
    soloPodium: "{leader} is undefeated. Literally."
  },
  64: {
    ...
    soloPodium: "{leader} is putting on a clinic."
  },
  63: {
    ...
    soloPodium: "{leader} is the headline act. You lot are the roadies."
  },
  62: {
    ...
    soloPodium: "{leader} is laughing. Everyone else is crying."
  },
  61: {
    ...
    soloPodium: "{leader} is sailing away. The rest of you missed the boat."
  },
  60: {
    ...
    soloPodium: "{leader} is the king/queen of the castle."
  },
  59: {
    ...
    soloPodium: "{leader} is the big cheese. You lot are the crackers."
  },
  58: {
    ...
    soloPodium: "Only {leader} has taste. The rest of you listen to elevator music."
  },
  57: {
    ...
    soloPodium: "{leader} is the sharpest tool in the shed."
  },
  56: {
    ...
    soloPodium: "{leader} is scorching. The rest of you are frozen."
  },
  55: {
    ...
    soloPodium: "{leader} is tall poppy. Time to cut them down? Anyone?"
  },
  54: {
    ...
    soloPodium: "{leader} is riding a unicorn. Everyone else is riding a donkey."
  },
  53: {
    ...
    soloPodium: "{leader} is the chosen one."
  },
  52: {
    ...
    soloPodium: "Winner, winner, chicken dinner for {leader}. The rest of you starve."
  },
  51: {
    ...
    soloPodium: "{leader} is conducting the orchestra. The rest of you are out of tune."
  },
  50: {
    ...
    soloPodium: "{leader} has broken the seal! The rest of you are holding it in."
  },
  49: {
    ...
    soloPodium: "{leader} is making you all look bad. Step it up."
  },
  48: {
    ...
    soloPodium: "One point for Gryffindor ({leader}). Zero for Slytherin (everyone else)."
  },
  47: {
    ...
    soloPodium: "{leader} is the smart one. Confirmed."
  },
  46: {
    ...
    soloPodium: "{leader} is holding the fort. The rest of you abandoned your posts."
  },
  45: {
    ...
    soloPodium: "{leader} is a pioneer. Exploring the scoreboard alone."
  },
  44: {
    ...
    soloPodium: "Stop the count! {leader} wins! (Because no one else has scored)."
  },
  43: {
    ...
    soloPodium: "{leader} is winning by default. The best kind of winning."
  },
  42: {
    ...
    soloPodium: "{leader} is on the podium. Alone. Looking awkward."
  },
  41: {
    ...
    soloPodium: "{leader} is drinking from the top shelf. You lot are drinking tap water."
  },
  40: {
    ...
    soloPodium: "Gold medal to {leader}. Everyone else didn't even qualify."
  },
  39: {
    ...
    soloPodium: "{leader} is the only one who studied for the test."
  },
  38: {
    ...
    soloPodium: "A masterclass from {leader}. A disasterclass from everyone else."
  },
  37: {
    ...
    soloPodium: "{leader} is strutting. Everyone else is stumbling."
  },
  36: {
    ...
    soloPodium: "{leader} takes the lead! Mostly because no one else has turned up."
  },
  35: {
    ...
    soloPodium: "Can someone check a pulse on the others? Only {leader} is alive."
  },
  34: {
    ...
    soloPodium: "{leader} is the alpha. The rest of you are betas."
  },
  33: {
    ...
    soloPodium: "Shining bright like a diamond! {leader} is the only light in this dark room."
  },
  32: {
    ...
    soloPodium: "{leader} is batting 100. The rest of the team is out for a duck."
  },
  31: {
    ...
    soloPodium: "{leader} is the captain now. Mutiny is impossible because you have no points."
  },
  30: {
    ...
    soloPodium: "It's {leader}'s world, we're just living in it (with zero points)."
  },
  29: {
    ...
    soloPodium: "{leader} is eating all the pies. Leave some points for the others!"
  },
  28: {
    ...
    soloPodium: "A solo performance by {leader}. The crowd goes mild!"
  },
  27: {
    ...
    soloPodium: "{leader} is building a house. Everyone else is still looking for the land."
  },
  26: {
    ...
    soloPodium: "Score check: {leader} has everything. You lot have nothing."
  },
  25: {
    ...
    soloPodium: "{leader} is the MVP. Everyone else is the water boy."
  },
  24: {
    ...
    soloPodium: "{leader} is awake! Everyone else is in a food coma."
  },
  23: {
    ...
    soloPodium: "One hit wonder! {leader} is on the board. The rest of you are wondering what happened."
  },
  22: {
    ...
    soloPodium: "{leader} is a diamond in the rough. The rest of you are just rough."
  },
  21: {
    ...
    soloPodium: "Just {leader}. That's it. That's the update."
  },
  20: {
    ...
    soloPodium: "{leader} is flying the flag. The rest of you have surrendered."
  },
  19: {
    ...
    soloPodium: "Breaking News: {leader} has points. Other News: Everyone else has nothing."
  },
  18: {
    ...
    soloPodium: "{leader} is the only one on the board. Is everyone else's wifi broken?"
  },
  17: {
    ...
    soloPodium: "Solo effort! {leader} scores a try while the rest of the team is at the pub."
  },
  16: {
    ...
    soloPodium: "{leader} is the teacher's pet. Everyone else is in detention."
  },
  15: {
    ...
    soloPodium: "If this was a group assignment, {leader} would be doing all the work."
  },
  14: {
    ...
    soloPodium: "Look at {leader} go! The only sign of life on the entire scoreboard."
  },
  13: {
    ...
    soloPodium: "{leader} is the designated driver of this group. Carrying everyone home."
  },
  12: {
    ...
    soloPodium: "We have a leader! {leader} breaks the deadlock. The rest of you are dead weight."
  },
  11: {
    ...
    soloPodium: "{leader} is playing 4D chess. Everyone else is playing checkers and losing."
  },
  10: {
    ...
    soloPodium: "{leader} has scored. The rest of you are still trying to find the stadium."
  },
  9: {
    ...
    soloPodium: "Hello? Is there anybody out there? Just {leader}? Okay then."
  },
  8: {
    ...
    soloPodium: "One is the loneliest number, but {leader} is loving it right now."
  },
  7: {
    ...
    soloPodium: "{leader} is drinking alone. It's sad, but they're winning, so who cares?"
  },
  6: {
    ...
    soloPodium: "Crickets... except for {leader}! They are the only noise on the scoreboard."
  },
  5: {
    ...
    soloPodium: "{leader} is currently the only person with taste. The rest of you should be ashamed."
  },
  4: {
    ...
    soloPodium: "Start the car! {leader} is driving off and leaving everyone else in the dust."
  },
  3: {
    ...
    soloPodium: "Lonely at the top! {leader} is sitting there all by themselves. Do the rest of you even like music?"
  },
  2: {
    ...
    soloPodium: "It's a one-horse race! {leader} is galloping towards glory while the rest of you are still in the stables."
  },
  1: {
...
export function getPodiumQuip(
  ...
  // Check for ties FIRST (before checking for other states)
  ...
  } else if (isSoloPodium) {
    // Only one person has points, rest are at 0
    quip = quipSet.soloPodium;
