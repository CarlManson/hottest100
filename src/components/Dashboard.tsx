    ...
    <div className="max-w-7xl mx-auto p-6">
      ...
      {!hasVotes && familyMembers.length === 0 ? (
        <div className="bg-white rounded-xl shadow-lg p-12 text-center border-2 border-orange-200">
          ...
          <h3 className="text-2xl font-bold mb-2 text-gray-800">Welcome to Hottest 100 Tracker!</h3>
          <p className="text-gray-600 mb-6">Get started by adding songs and family members</p>
          <div className="flex gap-4 justify-center">
            <button
              onClick={() => onNavigate?.('songs')}
              className="bg-orange-500 text-white px-6 py-3 rounded-lg hover:bg-orange-600 transition font-bold"
            >
              Add Songs
            </button>
            <button
